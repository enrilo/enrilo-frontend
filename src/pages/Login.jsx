  ...
  return (
    <main className="flex flex-1 justify-center items-center bg-gray-50 p-6">
      <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl">
        {/* Title */}
        <h1 className="text-[#1E293B] font-semibold text-2xl sm:text-3xl text-center mb-6">
          Login
        </h1>
        ...
        <form className="flex flex-col gap-4">
          ...
          <div className="mt-6 flex justify-center">
            <button type="submit" className="w-full sm:w-auto bg-[#1E293B] text-yellow-400 px-8 py-2 rounded-md hover:bg-[#334155] transition">
              Login
            </button>
          </div>
        </form>
