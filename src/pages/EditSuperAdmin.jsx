...
export default function EditSuperAdmin() {
    ...
    //     setDeletedProfile(false); // reset delete flag
    //     setNewProfileFile(file);

    //     // Preview
    //     if (file.type === "image/heic") {
    //         const blob = await heic2any({ blob: file, toType: "image/jpeg" });
    //         setPreviewProfileUrl(URL.createObjectURL(blob));
    //     } else {
    ...
    //     const invalidDocs = formData.documents.filter((doc) => !doc.url && (doc.name.trim() !== "" || doc.number.trim() !== ""));
    ...
    return (
        ...
        //                     <div className="flex flex-col items-center">
        //                         {/* <img src={formData.photo_url} alt="Profile" className="w-auto h-40 object-cover rounded-lg mb-2" /> */}
        //                         <img src={previewProfileUrl || formData.photo_url || "https://www.shutterstock.com/image-vector/vector-flat-illustration-grayscale-avatar-600nw-2264922221.jpg"} alt="Profile Photo" className="w-auto h-40 object-cover rounded-lg mb-2" />
