...
//   const [offices, setOffices] = useState([createDefaultOffice()]);
...
//     office_details: [createDefaultOffice()],
//   });
...
//     setOffices((prev) => [...prev, createDefaultOffice()]);
//   }, []);
...
//     setBranchType(type);
//     if (type === "single") setOffices([createDefaultOffice()]);
//   }, []);
...
//         is_single_branch: branchType === "single",
//         office_details: offices,
//       };
...
//                       <Select
//                         isDisabled={!allowWriteAccess}
//                         options={countryCodeOptions}
//                         value={countryCodeOptions.find(c => c.value === office.country_code) || null}
//                         placeholder="Country Code"
//                         isSearchable
//                         menuPortalTarget={document.body}
//                         styles={selectStyles}
//                         onChange={(sel) => handleOfficeChange(index, "country_code", sel?.value || "")}
//                       />
//                     </div>
//                   </div>
