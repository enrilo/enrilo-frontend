...
//   const roleOptions = [{ value: "", label: "All" }, { value: "admin", label: "Admin" }, { value: "user", label: "User" }];
...
//     const newFilters = { full_name: params.get("full_name") || "", role: params.get("role") || "", company_email: params.get("company_email") || "", phone: params.get("phone") || "", position: params.get("position") || "" };
...
//             </div>
//             <div>
//               <Select id="role" options={roleOptions} value={selectedRole} placeholder="Role" isSearchable menuPortalTarget={document.body} styles={selectStyles}
//                 onChange={(sel) => {
//                     setSelectedRole(sel);
//                     handleFilterChange("role", sel?.value || ""); // Update your filters state
//                   }}
//                 />
//             </div>
//             <div>
...
//                                   className="bg-red-700 hover:bg-red-600 text-white px-2 sm:px-3 py-1 sm:py-1.5 rounded text-sm sm:text-[17px] font-semibold transition cursor-pointer"
//                                 >
//                                   Delete
//                                 </button>
//                               </>
...
//                         <span>
//                           {rowsPerPage === -1
//                             ? `1–${allSuperAdmin.length} of ${allSuperAdmin.length}`
//                             : `${Math.min(page * rowsPerPage + 1, allSuperAdmin.length)}–${Math.min(
//                                 (page + 1) * rowsPerPage,
//                                 allSuperAdmin.length
//                               )} of ${allSuperAdmin.length}`}
//                         </span>
//                         <button
//                           onClick={() => setPage(0)}
...
//                         <button
//                           onClick={() =>
//                             setPage((p) => Math.min(p + 1, Math.ceil(allSuperAdmin.length / rowsPerPage) - 1))
//                           }
//                           disabled={page >= Math.ceil(allSuperAdmin.length / rowsPerPage) - 1 || rowsPerPage === -1}
//                           className="px-2 py-1 border rounded disabled:opacity-40"
//                         >
//                           <ChevronRightRoundedIcon fontSize="small" />
//                         </button>
//                         <button
//                           onClick={() => setPage(Math.ceil(allSuperAdmin.length / rowsPerPage) - 1)}
//                           disabled={page >= Math.ceil(allSuperAdmin.length / rowsPerPage) - 1 || rowsPerPage === -1}
//                           className="px-2 py-1 border rounded disabled:opacity-40"
//                         >
