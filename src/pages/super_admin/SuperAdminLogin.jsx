        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="mt-6 flex justify-center">
            <button
              type="submit"
              disabled={loading}
              className="w-full cursor-pointer sm:w-auto bg-[#1E293B] hover:bg-[#334155] text-yellow-300 font-semibold px-8 py-2 rounded-md transition disabled:opacity-60"
            >
      ...
      {messageOpen && (
        <div className="fixed inset-0 backdrop-blur-md flex justify-center items-center z-50">
          <div className="bg-white text-[#334155] rounded-lg p-6 max-w-lg w-full shadow-xl text-center">
            <p className="mb-6 text-xl font-medium">{modalMessage}</p>
            <button
              className="bg-[#1E293B] hover:bg-[#334155] text-yellow-300 font-semibold px-5 py-3 rounded-md w-28 transition cursor-pointer text-base"
              onClick={() => {
