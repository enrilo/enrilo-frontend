...
//     if (!confirm("Delete current profile picture?")) return;
...
//     if (!file) return;
//     const validTypes = ["image/jpeg", "image/jpg", "image/png", "image/heic", "application/pdf"];
//     if (!validTypes.includes(file.type)) return alert("Please upload a JPG, JPEG, PNG, HEIC, or PDF.");
...
//     setConfirmAction(() => () => handleDeleteFile(index)); // wrap in function to defer execution
//     setConfirmOpen(true);
//   };
...
//   // --- UPDATED removeDocument function ---
//   const removeDocument = async (index) => {
//     const filePath = formData.documents[index]?.firebasePath; // ✅ get firebase path of this specific doc
//     if (filePath) {
...
//     // ✅ Only remove this document from array without affecting others
//     setFormData((p) => ({ ...p, documents: p.documents.filter((_, i) => i !== index) }));
//   };
...
//                     <input type="file" accept=".jpg,.jpeg,.png,.heic" hidden onChange={handleProfileUpload} disabled={uploadingProfile} />
//                   </label>
//                   <button type="button" className="text-red-600 cursor-pointer hover:underline" onClick={handleDeleteProfile}>
//                     Delete
//                   </button>
//                 </div>
//               </div>
...
//                           {/* <Button color="error" variant="outlined" onClick={() => handleDeleteFile(i)}>Delete</Button> */}
//                           <Button color="error" variant="outlined" onClick={() => handleDeleteFile(i)}>Delete</Button> 
...
//                 <p className="text-center font-medium mb-4">{confirmMessage}</p>
//                 <div className="flex justify-center gap-4">
//                   <button
//                     className="bg-[#2563EB] text-white px-4 py-2 rounded-md hover:bg-[#1D4ED8] transition"
//                     onClick={() => {
...
//                 <button
//                   className="bg-[#1E293B] text-white px-6 py-2 rounded-md hover:bg-[#334155] transition cursor-pointer"
