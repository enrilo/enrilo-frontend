...
export default function AddNewSuperAdmin() {
  ...
  const [previewDoc, setPreviewDoc] = useState(null); // <-- store full doc
          ...
          <form className="grid grid-cols-1 md:grid-cols-3 gap-4" onSubmit={handleSubmit}>
            ...
            <div className="w-full flex gap-3">
              <div className="min-w-[140px]">
                <Select options={options} value={selectedCode} placeholder="Country Code" styles={selectStyles}
                  onChange={(sel) => {
                    setSelectedCode(sel);
            ...
            {/* Rest of the fields */}
            <TextField id="company_email" value={formData.company_email} onChange={handleChange} label="Company Email" variant="outlined" fullWidth required />
